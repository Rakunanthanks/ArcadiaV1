...
public class TerminalsComponentDBPage extends BasePage {
    ...
    public List<TerminalsComponentDB> getTerminalsData() throws InterruptedException {
        ...
        for( WebElement element : componentDbElement){
            ...
            String gender= tdElements.get(11).getText();
            String type= tdElements.get(12).getText();
            String finish= tdElements.get(13).getText();
            String material= tdElements.get(14).getText();
            Double stripLength= Double.valueOf(tdElements.get(15).getText());
